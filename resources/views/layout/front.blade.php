...
<header>
    <div class="upper-head clearfix" style="background-color: #EC3237;">
        <div class="container">
        ...
        <div class="navigation-content">
            <div class="header_menu">
                ...
                <nav class="navbar navbar-default navbar-sticky-function navbar-arrow">
                    ...
                    <a href="/">
                <img alt="Image" src="/assets/images/samiritravel/logo.png" height="60" style="object-fit: contain; width: 100%;"></a>
                    </div>
                    <div id="navbar" class="navbar-nav-wrapper">
    <ul class="nav navbar-nav" id="responsive-menu">
        <li class="{{ Route::currentRouteName() == 'home' ? 'active' : '' }}">
            <a href="{{ route('home') }}" 
               style="color: {{ Route::currentRouteName() == 'home' ? '#EC3237;' : '#000' }};"
               onmouseover="this.style.color='#EC3237'" 
               onmouseout="this.style.color='{{ Route::currentRouteName() == 'home' ? '#EC3237' : '#000' }}'">
               @lang('Home')
            </a>
        </li>
        <li class="{{ Route::currentRouteName() == 'about' ? 'active' : '' }}">
            <a href="{{ route('about') }}" 
               style="color: {{ Route::currentRouteName() == 'about' ? '#EC3237' : '#000' }};"
               onmouseover="this.style.color='#EC3237'" 
               onmouseout="this.style.color='{{ Route::currentRouteName() == 'about' ? '#EC3237' : '#000' }}'">
               @lang('About us')
            </a>
        </li>
        <li class="{{ Route::currentRouteName() == 'tours' ? 'active' : '' }}">
            <a href="{{ route('tour.index') }}" 
               style="color: {{ Route::currentRouteName() == 'tours' ? '#EC3237' : '#000' }};"
               onmouseover="this.style.color='#EC3237'" 
               onmouseout="this.style.color='{{ Route::currentRouteName() == 'tours' ? '#EC3237' : '#000' }}'">
               @lang('Tours')
            </a>
        </li>
        <li class="{{ Route::currentRouteName() == 'contact' ? 'active' : '' }}">
            <a href="{{ route('contact') }}" 
               style="color: {{ Route::currentRouteName() == 'contact' ? '#EC3237' : '#000' }};"
               onmouseover="this.style.color='#EC3237'" 
               onmouseout="this.style.color='{{ Route::currentRouteName() == 'contact' ? '#EC3237' : '#000' }}'">
               @lang('Contact')
            </a>
        </li>
    </ul>
            ...
            <span class="slicknav_icon-bar"></span>
                ...
                <ul class="slicknav_nav" id="mobileNavShow" style="display:none" aria-hidden="false" role="menu">
                        ...
                        @else 
                            <li> 
                        @endif
                            <a href="{{ route('contact') }}" style="color: #EC3237">@lang('Contact')</a>
                        </li>
                    </ul>
