...
@section('content')
    <section class="swiper-banner">
        <div class="slider">
                        ...
                        <div class="swiper-slide" style="background-image:url({{  $slider->image->url  ?? 'https://samiratravel.uz/storage/gallery/37/1715602217_4.jpg'}})">
                            <div class="swiper-content" data-animation="animated fadeInDown">
                                ...
                                <a href="{{ route('tour.show',['id'=>$slider->id]) }}" 
                                    class="btn-blue" 
                                    style="background-color: #EC3237; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; border: none;">
                                    @lang('Order')
                                </a>
            ...
            <div class="swiper-button-next" style="background-color: #EC3237;"></div>
            <div class="swiper-button-prev" style="background-color: #EC3237;"></div>
